...
const { features, bbox, type } = world
const finalSauid = features.filter((f) => {
  return (
    f.properties.region_wb === 'Middle East & North Africa' ||
    f.properties.subregion === 'Eastern Africa' ||
    f.properties.subregion === 'Northern Africa'
  )
})

const SaudiArabia = JSON.stringify({ bbox, type, features: finalSauid }) //?
