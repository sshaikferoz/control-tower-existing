...
export default function Procurement(props) {
  ...
  const alertsQry = [
    ...
    { title: 'Near Expiry Contracts', techname: 'YCDEXDB_CT_PROC_NA_CONTRACT' },
  ...
  const activeDispute = {
    title: 'Active Disputes, Claims & Appeals',
    ...
    >
      ...
      <div className={styles.procurementContainer}>
        <div className={styles.artboard}>
          <img
            src={`${process.env.NEXT_PUBLIC_BSP_NAME}/images/tower.png`}
          />
        </div>
        <div className={styles.bigColumn}>
          ...
          <div className={styles.row1}>
            <Block title={activeDispute.title}>
            ...
            >
              ...
              >
                <img
                  ...
                  src={`${process.env.NEXT_PUBLIC_BSP_NAME}/images/proc-alert-sticker.png`}
                  alt="alert sticker"
                />
              </div>
            </ConfigurableAlert>*/}
