...
export default function SpendPredictionLineChart(props) {
    ...
    // Customize x-axis labels for contract and material spend charts
    function customizeArgumentAxisText(arg) {
        const isContractOrMaterial = TechnicalName?.includes('SRV_SPEND') || TechnicalName?.includes('MAT_SPEND')
        if (!isContractOrMaterial) {
            return arg.value
        }
        ...
        // Handle string format like "MAR 2025"
        if (typeof value === 'string' && value.match(/^[A-Z]{3} \d{4}$/)) {
            return value
        }
        ...
        if (!isNaN(value)) {
            ...
            if (str.length === 6) {
                ...
                const monthNum = parseInt(str.substring(4, 6), 10) - 1
                const monthNames = ['JAN', 'FEB', 'MAR', 'APR', 'MAY', 'JUN', 'JUL', 'AUG', 'SEP', 'OCT', 'NOV', 'DEC']
                ...
                <Chart
                    ...
                    argumentAxis={{
                        ...
                        label: {
                            ...
                            customizeText: customizeArgumentAxisText,
                        },
                        ...argumentAxisProps,
                    }}
                    valueAxis={{
